/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2deb3bb95166df1753bdf16447326c37)
// Runtime types generated with workerd@1.20260107.1 2024-01-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/functions/index");
	}
	interface Env {
		YOU_BLOCKED_ME: KVNamespace;
		AMAP_SECURITY_KEY: string;
		SERVER3_SEND_KEY: string;
		ENVIRONMENT: string;
	}
}
